//
//  FreqDomainProcessing.hpp
//
//  Created by Fernando Mujica on 1/27/18.
//  Copyright © 2018 Stanford University. All rights reserved.
//

#ifndef FreqDomainProcessing_hpp
#define FreqDomainProcessing_hpp
...
public:
    ...
    void test(const int16_t *inputData,
              int inputNumSamples,
              int mode);
...
#endif /* FreqDomainProcessing_hpp */
